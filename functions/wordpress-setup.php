...
function customise_theme_color_picker( $wp_customize) {
    ...
    $colorArray = [array('name' => 'background', 'color' => '#3D3D3F'), array('name' => 'primary', 'color' => '#942192'), array('name' => 'primary-variant', 'color' => '#0433FF')];
...
function generate_theme_custom_colours() {
    ...
    $colorArray = ['background','primary','primary-variant'];
    $colorRuleArray = [];
